...
SimpleForm.setup do |config|
  ...
  config.wrappers :semantic, tag: 'div',
                             class: 'field',
                             error_class: 'error',
    ...
    b.use :error, wrap_with: { tag: 'div', class: 'ui red left pointing basic label' }
  end

  config.wrappers :semantic_checkbox, tag: 'div',
                                      class: 'inline field',
                                      error_class: 'error',
                                      hint_class: 'with_hint' do |b|
    b.use :html5
    b.wrapper tag: 'div', class: 'ui checkbox' do |input|
      input.use :input
      input.wrapper(tag: 'label') {}
    end
    b.use :label
  end

  config.wrappers :semantic_checkbox_slider, tag: 'div',
                                             class: 'inline field',
                                             error_class: 'error',
                                             hint_class: 'with_hint' do |b|
    b.use :html5
  ...
  config.wrappers :semantic_checkbox_toggle, tag: 'div',
                                             class: 'inline field',
                                             error_class: 'error',
                                             hint_class: 'with_hint' do |b|
    b.use :html5
